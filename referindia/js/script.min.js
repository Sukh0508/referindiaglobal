...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const PROJECTS = {
        ...
        3: {
            title: "AlumniSoft – Alumni management for corporates & universities",
    ...
    if (DOM.cursorDot && DOM.cursorRing) {
        if (!isMobile()) {
            ...
            // Hover effects (Event Delegation for better compatibility with modals/dynamic content)
            window.addEventListener('mouseover', (e) => {
                ...
                if (DOM.cursorRing) {
                    if (isClickable) {
                        ...
                        DOM.cursorRing.style.borderColor = 'rgba(0, 166, 255, 1)';
                        DOM.cursorRing.style.background = 'rgba(0, 166, 255, 0.05)';
                    } else {
                        DOM.cursorRing.style.width = '36px';
                        DOM.cursorRing.style.height = '36px';
                        DOM.cursorRing.style.borderColor = 'rgba(0, 166, 255, 0.6)';
                        DOM.cursorRing.style.background = 'transparent';
                    }
                }
            });
        } else {
    ...
    if (DOM.modal) {
        const openProjectModal = (projectId) => {
            ...
            const linkElement = DOM.modal.querySelector('.modal-link');
